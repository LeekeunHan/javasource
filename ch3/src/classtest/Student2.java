...
public class Student2 {
	...
	//생성자오버로딩 : 여러개 올수 있음 (단 default 무조곤 하나 , 인자를 받는 생성자가 여러개로 오는것)
	// 객체를 생성할때 자동 호출 
	public Student2() {
		// default 생성자 (무조곤 하나만 존재)
		System.out.println("Student2 객체 생성");
	}   
	public Student2(int studentId,String studentName) {
		System.out.println("인자를받는 Student2 객체생성(1)");
		// 인자를 받는 생성자
		// this : 객체 자기 자신 
	...
	public Student2(int studentId,String studentName,String address) {
		System.out.println("인자를받는 Student2 객체생성(2)"); 
		this.studentId=studentId;
		this.studentName=studentName;
	...
	public Student2(int studentId,String studentName,String address,String mobile) {
		System.out.println("인자를받는 Student2 객체생성(3)");
		this.studentId=studentId;
		this.studentName=studentName;
		this.address=address;
		this.mobile=mobile;
	...
	// main이 없으면 console 창에서 결과창을 볼수 없다. 
}
