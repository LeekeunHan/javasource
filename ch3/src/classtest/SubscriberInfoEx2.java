...
public class SubscriberInfoEx2 {
	...
	public static void main(String[] args) {
		...
		//기본타입(byte,short,char,boolean...)의 초기화는 null 을 줄수없음 
		//int a= null;
		...
		info[1]=new SubscriberInfo("성춘향", "sung1234", "sung1234%", "010-0000-0000", "경기도남양주시");
		info[2]=new SubscriberInfo("송중기", "s1234", "s1234%", "010-0340-0000", null);
